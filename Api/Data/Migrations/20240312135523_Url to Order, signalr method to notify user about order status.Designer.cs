...
namespace Api.Data.Migrations
{
    ...
    [Migration("20240312135523_Url to Order, signalr method to notify user about order status")]
    partial class UrltoOrdersignalrmethodtonotifyuseraboutorderstatus
    {
